...
public final class Spliterators {
    ...
    private static final Spliterator.OfLong EMPTY_LONG_SPLITERATOR =
            null;//new EmptySpliterator.OfLong();
    ...
    private static abstract class EmptySpliterator<T, S extends Spliterator<T>, C> {
        ...
        private static final class OfRef<T>
            ...
            Objects.requireNonNull(consumer);
             ...
             public long getExactSizeIfKnown(){return 0;}
             public boolean hasCharacteristics(int i){return false;}
...
public void forEachRemaining(Consumer c){}
public boolean tryAdvance(Consumer c){return false;}
public long getExactSizeIfKnown(){
            return 0;
        }
        public boolean hasCharacteristics(int i){
...
//@Override
    ...
    public static abstract class AbstractSpliterator<T> implements Spliterator<T> {
        ...
        static final class HoldingConsumer<T> implements Consumer<T> {
            ...
            public Consumer andThen(Consumer c){
                return null;
            }
        }
...
public void forEachRemaining(Consumer c){}
public boolean tryAdvance(Consumer c){return false;}
public boolean tryAdvance(IntConsumer c){return false;}
public long getExactSizeIfKnown(){
            return 0;
        }
        public boolean hasCharacteristics(int i){
...
public void forEachRemaining(LongConsumer c){}
public void forEachRemaining(Consumer c){}
public boolean tryAdvance(Consumer c){return false;}
public boolean tryAdvance(LongConsumer c){return false;}
public long getExactSizeIfKnown(){
            return 0;
        }
        public boolean hasCharacteristics(int i){
...
public void forEachRemaining(DoubleConsumer c){}
public void forEachRemaining(Consumer c){}
public boolean tryAdvance(Consumer c){return false;}
public boolean tryAdvance(DoubleConsumer c){return false;}
public long getExactSizeIfKnown(){
            return 0;
        }
        public boolean hasCharacteristics(int i){
        ...
        static final class HoldingDoubleConsumer implements DoubleConsumer {
            ...
            public DoubleConsumer andThen(DoubleConsumer d){
            return null;
            }
        }
