  ...
  public final void writeObject (Object obj) throws IOException
  {
	...
	if (obj instanceof ObjectStreamClass)
	{
	  ...
	  ObjectStreamField field;
            for (ObjectStreamField field1 : fields) {
                field = field1;
	...
	ObjectStreamClass osc = (ObjectStreamClass) ObjectStreamClass.lookup (clazz);
	if (osc == null)
    ...
    Class type;
      for (ObjectStreamField field : fields) {
          ...
          /*if (type == Boolean.TYPE)
              ...
              writeObject (getObjectField (obj, field_name, TypeSignature.getEncodingOfClass (type)));*/
      }
  }
