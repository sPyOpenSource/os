 ...
 */
public class UHCIPipeManager implements USBConstants {
     ...
     * The list of pipes
     */
    private final ArrayList<USBPipe> pipes = new ArrayList<>();
    /**
     * The schedule
     */
     ...
     */
    public UHCIPipeManager(MemoryManager rm, Schedule schedule) {
        this.rm = rm;
